...
char keypad_scanner(void)
{
            ...
            if (RB4 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB4==0); return '1'; }
            if (RB5 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB5==0); return '2'; }
            if (RB6 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB6==0); return '3'; }
            if (RB7 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB7==0); return 'A'; }

            RB0 = 1; RB1 = 0; RB2 = 1; RB3 = 1;
            if (RB4 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB4==0); return '4'; }
            if (RB5 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB5==0); return '5'; }
            if (RB6 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB6==0); return '6'; }
            if (RB7 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB7==0); return 'B'; }

            RB0 = 1; RB1 = 1; RB2 = 0; RB3 = 1;
            if (RB4 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB4==0); return '7'; }
            if (RB5 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB5==0); return '8'; }
            if (RB6 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB6==0); return '9'; }
            if (RB7 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB7==0); return 'C'; }

            RB0 = 1; RB1 = 1; RB2 = 1; RB3 = 0;
            if (RB4 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB4==0); return '*'; }
            if (RB5 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB5==0); return '0'; }
            if (RB6 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB6==0); return '#'; }
            if (RB7 == 0) { _delay((unsigned long)((100)*(800000000/4000.0))); while (RB7==0); return 'D'; }
